...
final evidenceArticlesProvider = Provider<List<EvidenceArticle>>((ref) {
  return const [
    EvidenceArticle(
      slug: 'what-is-pcos',
      title: 'What is PCOS?',
      summary: 'PCOS is a long-term condition that affects cycles, hormones, and metabolism.',
      body:
    ...
    EvidenceArticle(
      ...
      summary: 'No single diet has clear evidence of being best for everyone with PCOS.',
      body:
    ...
    EvidenceArticle(
      ...
      summary: 'Escalating pain, missed periods, or medication issues should be reviewed with a clinician.',
      body:
